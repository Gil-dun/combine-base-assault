...
#ifdef CBA // Blixibon - APC spotlight
...
int CPropDrivableAPC::OnTakeDamage(const CTakeDamageInfo & inputInfo)
{
	...
	if (GetDriver())
	{
		...
		// 0.15 / 2 / 10 = 0.0075
		// In CBA, we want it to have half of the normal damage modifier divided by 10 
...
{
#ifndef CBA // Blixibon - The headlight stays on in E:Z
	HeadlightTurnOff();
#endif
